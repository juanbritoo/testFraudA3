...
y_prob_ensemble = ensemble_final.predict_proba(X_test)[:, 1]

print("\nRESULTADOS DO ENSEMBLE FINAL:")
print("═" * 50)
print("\nRelatório de Classificação:\n", classification_report(y_test, y_pred_ensemble))
print("AUC do Ensemble:", roc_auc_score(y_test, y_prob_ensemble))
print("\nMatriz de Confusão:\n", confusion_matrix(y_test, y_pred_ensemble))


ensemble_path = os.path.join(pasta_modelos, "modelo_final_ensemble.pkl")
joblib.dump(ensemble_final, ensemble_path)

print("Sistema Fraud Guard Concluído!!")